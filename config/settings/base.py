...
# agent_chat_app/
APPS_DIR = BASE_DIR / "agent_chat_app"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///agent_chat_app",
    ),
}
...
LOCAL_APPS = [
    "agent_chat_app.users",
    "agent_chat_app.chat",  # Chat application
    "agent_chat_app.receipts",  # Receipt processing system
    "agent_chat_app.logviewer",  # Log viewer system
...
MIGRATION_MODULES = {"sites": "agent_chat_app.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "agent_chat_app.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Marcin""", "marcin.ubogi@gmail.com")]
...
LOGGING = {
    ...
    'handlers': {
        ...
        'database': {
            'level': 'INFO',
            'class': 'agent_chat_app.logviewer.handlers.DatabaseLogHandler',
            'formatter': 'verbose',
        },
    },
    'root': {
...
# Cache settings for RAG and other features
RAG_CACHE_TTL = 60 * 60  # 1 hour
CONVERSATION_CACHE_TTL = 60 * 15  # 15 minutes
USER_SETTINGS_CACHE_TTL = 60 * 30  # 30 minutes
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "agent_chat_app.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "agent_chat_app.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "agent_chat_app.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "agent_chat_app.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Intelligent AI Assistant with Document Analysis - RESTful API Documentation',
    'VERSION': '1.0.0',
    ...
    'ENUM_NAME_OVERRIDES': {
        'ValidationErrorEnum': 'agent_chat_app.contrib.api.enums.ValidationErrorEnum.choices',
    },
    ...
    'TAGS': [
        ...
        {'name': 'Documents', 'description': 'Document upload and RAG operations'},
        {'name': 'User Settings', 'description': 'User preferences and configuration'},
